...
creature5 = Creature.create!(name:'Fairy', super_power:'I can make your dreams come true', price:'120',user_id: user3.id)
...
review2 = Review.create!(description: 'Amy likes everything', rating: 10)
booking7.update(review_id: review2.id)
review3 = Review.create!(description: 'that flying camel is killing it ', rating: 10)
booking8.update(review_id: review3.id)
review4 = Review.create!(description: 'blablabla', rating: 1)
